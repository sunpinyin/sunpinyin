...
#define QUANPIN_AUTOCORRECTING_ENABLED  "QuanPin/AutoCorrecting/Enabled"
#define QUANPIN_AUTOCORRECTING_PINYINS  "QuanPin/AutoCorrecting/Pinyins"
#define SHUANGPIN_TYPE                  "ShuangPin/Type"
